        ...
        axios.post('/api/schedule', schedule)
            .then(response => {
                ...
                const additionalData = {
                    ...
                    teacherId: selectStaff,
                };

                axios.post('/api/course', { ...state, ...additionalData })
                    .then(() => {
        ...
        <div className="shadow-[0_3px_10px_rgb(0,0,0,0.2)]">
            ...
            <div className="flex justify-center p-4 flex-col">
                <div className="shadow-[0_3px_10px_rgb(0,0,0,0.2)] mx-auto w-[350px] py-2 mb-[20px]">
                    <h1 className="text-center uppercase text-[30px]">Tạo Khóa Học</h1>
                </div>
                <form className="flex flex-col gap-4" >
                    <div className="flex flex-row">
                        ...
                        <div className="flex flex-col p-4 w-[50%]">
                            ...
                            <p className="mb-[10px] text-[20px]">Chọn giáo viên giảng dạy:</p>
                            <SelectStaff selectStaff={selectStaff} setSelectStaff={setSelectStaff} staffSelect={null} />
                        ...
                        <div className="flex flex-col p-4 w-[50%]">
                            ...
                            <div className="flex flex-col mb-[10px]">
                                <div className="flex flex-row items-center">
                                    ...
                                    <div className="flex flex-row items-center mr-[40px]">
                                        <input type="radio" id="mondayOne" name="mondayMorning" value="1" className="w-[20px] h-[20px] mr-[10px]" onClick={() => setSchedule((prevState) => ({ ...prevState, monday: prevState.monday.map((item, index) => index === 0 ? '1' : index === 1 ? '0' : item) }))} />
                                    ...
                                    <div className="flex flex-row items-center mr-[40px]">
                                        <input type="radio" id="mondayTwo" name="mondayMorning" value="1" className="w-[20px] h-[20px] mr-[10px]" onClick={() => setSchedule((prevState) => ({ ...prevState, monday: prevState.monday.map((item, index) => index === 1 ? '1' : index === 0 ? '0' : item) }))} />
                                ...
                                <div className="flex flex-row items-center">
                                    ...
                                    <div className="flex flex-row items-center mr-[40px]">
                                        <input type="radio" id="mondayThree" name="mondayAfternoon" value="1" className="w-[20px] h-[20px] mr-[10px]" onClick={() => setSchedule((prevState) => ({ ...prevState, monday: prevState.monday.map((item, index) => index === 2 ? '1' : index === 3 ? '0' : item) }))} />
                                    ...
                                    <div className="flex flex-row items-center mr-[40px]">
                                        <input type="radio" id="mondayFour" name="mondayAfternoon" value="1" className="w-[20px] h-[20px] mr-[10px]" onClick={() => setSchedule((prevState) => ({ ...prevState, monday: prevState.monday.map((item, index) => index === 3 ? '1' : index === 2 ? '0' : item) }))} />
                                ...
                                <div className="flex flex-row items-center">
                                    ...
                                    <div className="flex flex-row items-center mr-[40px]">
                                        <input type="radio" id="mondayFive" name="mondayEvening" value="1" className="w-[20px] h-[20px] mr-[10px]" onClick={() => setSchedule((prevState) => ({ ...prevState, monday: prevState.monday.map((item, index) => index === 4 ? '1' : index === 5 ? '0' : item) }))} />
                                    ...
                                    <div className="flex flex-row items-center mr-[40px]">
                                        <input type="radio" id="mondaySix" name="mondayEvening" value="1" className="w-[20px] h-[20px] mr-[10px]" onClick={() => setSchedule((prevState) => ({ ...prevState, monday: prevState.monday.map((item, index) => index === 5 ? '1' : index === 4 ? '0' : item) }))} />
                            ...
                            <div className="flex flex-col mb-[10px]">
                                <div className="flex flex-row items-center">
                                    ...
                                    <div className="flex flex-row items-center mr-[40px]">
                                        <input type="radio" id="tuesdayOne" name="tuesdayMorning" value="1" className="w-[20px] h-[20px] mr-[10px]" onClick={() => setSchedule((prevState) => ({ ...prevState, tuesday: prevState.tuesday.map((item, index) => index === 0 ? '1' : index === 1 ? '0' : item) }))} />
                                    ...
                                    <div className="flex flex-row items-center mr-[40px]">
                                        <input type="radio" id="tuesdayTwo" name="tuesdayMorning" value="1" className="w-[20px] h-[20px] mr-[10px]" onClick={() => setSchedule((prevState) => ({ ...prevState, tuesday: prevState.tuesday.map((item, index) => index === 1 ? '1' : index === 0 ? '0' : item) }))} />
                                ...
                                <div className="flex flex-row items-center">
                                    ...
                                    <div className="flex flex-row items-center mr-[40px]">
                                        <input type="radio" id="tuesdayThree" name="tuesdayAfternoon" value="1" className="w-[20px] h-[20px] mr-[10px]" onClick={() => setSchedule((prevState) => ({ ...prevState, tuesday: prevState.tuesday.map((item, index) => index === 2 ? '1' : index === 3 ? '0' : item) }))} />
                                    ...
                                    <div className="flex flex-row items-center mr-[40px]">
                                        <input type="radio" id="tuesdayFour" name="tuesdayAfternoon" value="1" className="w-[20px] h-[20px] mr-[10px]" onClick={() => setSchedule((prevState) => ({ ...prevState, tuesday: prevState.tuesday.map((item, index) => index === 3 ? '1' : index === 2 ? '0' : item) }))} />
                                ...
                                <div className="flex flex-row items-center">
                                    ...
                                    <div className="flex flex-row items-center mr-[40px]">
                                        <input type="radio" id="tuesdayFive" name="tuesdayEvening" value="1" className="w-[20px] h-[20px] mr-[10px]" onClick={() => setSchedule((prevState) => ({ ...prevState, tuesday: prevState.tuesday.map((item, index) => index === 4 ? '1' : index === 5 ? '0' : item) }))} />
                                    ...
                                    <div className="flex flex-row items-center mr-[40px]">
                                        <input type="radio" id="tuesdaySix" name="tuesdayEvening" value="1" className="w-[20px] h-[20px] mr-[10px]" onClick={() => setSchedule((prevState) => ({ ...prevState, tuesday: prevState.tuesday.map((item, index) => index === 5 ? '1' : index === 4 ? '0' : item) }))} />
                            ...
                            <div className="flex flex-col mb-[10px]">
                                <div className="flex flex-row items-center">
                                    ...
                                    <div className="flex flex-row items-center mr-[40px]">
                                        <input type="radio" id="wednesdayOne" name="wednesdayMorning" value="1" className="w-[20px] h-[20px] mr-[10px]" onClick={() => setSchedule((prevState) => ({ ...prevState, wednesday: prevState.wednesday.map((item, index) => index === 0 ? '1' : index === 1 ? '0' : item) }))} />
                                    ...
                                    <div className="flex flex-row items-center mr-[40px]">
                                        <input type="radio" id="wednesdayTwo" name="wednesdayMorning" value="1" className="w-[20px] h-[20px] mr-[10px]" onClick={() => setSchedule((prevState) => ({ ...prevState, wednesday: prevState.wednesday.map((item, index) => index === 1 ? '1' : index === 0 ? '0' : item) }))} />
                                ...
                                <div className="flex flex-row items-center">
                                    ...
                                    <div className="flex flex-row items-center mr-[40px]">
                                        <input type="radio" id="wednesdayThree" name="wednesdayAfternoon" value="1" className="w-[20px] h-[20px] mr-[10px]" onClick={() => setSchedule((prevState) => ({ ...prevState, wednesday: prevState.wednesday.map((item, index) => index === 2 ? '1' : index === 3 ? '0' : item) }))} />
                                    ...
                                    <div className="flex flex-row items-center mr-[40px]">
                                        <input type="radio" id="wednesdayFour" name="wednesdayAfternoon" value="1" className="w-[20px] h-[20px] mr-[10px]" onClick={() => setSchedule((prevState) => ({ ...prevState, wednesday: prevState.wednesday.map((item, index) => index === 3 ? '1' : index === 2 ? '0' : item) }))} />
                                ...
                                <div className="flex flex-row items-center">
                                    ...
                                    <div className="flex flex-row items-center mr-[40px]">
                                        <input type="radio" id="wednesdayFive" name="wednesdayEvening" value="1" className="w-[20px] h-[20px] mr-[10px]" onClick={() => setSchedule((prevState) => ({ ...prevState, wednesday: prevState.wednesday.map((item, index) => index === 4 ? '1' : index === 5 ? '0' : item) }))} />
                                    ...
                                    <div className="flex flex-row items-center mr-[40px]">
                                        <input type="radio" id="wednesdaySix" name="wednesdayEvening" value="1" className="w-[20px] h-[20px] mr-[10px]" onClick={() => setSchedule((prevState) => ({ ...prevState, wednesday: prevState.wednesday.map((item, index) => index === 5 ? '1' : index === 4 ? '0' : item) }))} />
                            ...
                            <div className="flex flex-col mb-[10px]">
                                <div className="flex flex-row items-center">
                                    ...
                                    <div className="flex flex-row items-center mr-[40px]">
                                        <input type="radio" id="thursdayOne" name="thursdayMorning" value="1" className="w-[20px] h-[20px] mr-[10px]" onClick={() => setSchedule((prevState) => ({ ...prevState, thursday: prevState.thursday.map((item, index) => index === 0 ? '1' : index === 1 ? '0' : item) }))} />
                                    ...
                                    <div className="flex flex-row items-center mr-[40px]">
                                        <input type="radio" id="thursdayTwo" name="thursdayMorning" value="1" className="w-[20px] h-[20px] mr-[10px]" onClick={() => setSchedule((prevState) => ({ ...prevState, thursday: prevState.thursday.map((item, index) => index === 1 ? '1' : index === 0 ? '0' : item) }))} />
                                ...
                                <div className="flex flex-row items-center">
                                    ...
                                    <div className="flex flex-row items-center mr-[40px]">
                                        <input type="radio" id="thursdayThree" name="thursdayAfternoon" value="1" className="w-[20px] h-[20px] mr-[10px]" onClick={() => setSchedule((prevState) => ({ ...prevState, thursday: prevState.thursday.map((item, index) => index === 2 ? '1' : index === 3 ? '0' : item) }))} />
                                    ...
                                    <div className="flex flex-row items-center mr-[40px]">
                                        <input type="radio" id="thursdayFour" name="thursdayAfternoon" value="1" className="w-[20px] h-[20px] mr-[10px]" onClick={() => setSchedule((prevState) => ({ ...prevState, thursday: prevState.thursday.map((item, index) => index === 3 ? '1' : index === 2 ? '0' : item) }))} />
                                ...
                                <div className="flex flex-row items-center">
                                    ...
                                    <div className="flex flex-row items-center mr-[40px]">
                                        <input type="radio" id="thursdayFive" name="thursdayEvening" value="1" className="w-[20px] h-[20px] mr-[10px]" onClick={() => setSchedule((prevState) => ({ ...prevState, thursday: prevState.thursday.map((item, index) => index === 4 ? '1' : index === 5 ? '0' : item) }))} />
                                    ...
                                    <div className="flex flex-row items-center mr-[40px]">
                                        <input type="radio" id="thursdaySix" name="thursdayEvening" value="1" className="w-[20px] h-[20px] mr-[10px]" onClick={() => setSchedule((prevState) => ({ ...prevState, thursday: prevState.thursday.map((item, index) => index === 5 ? '1' : index === 4 ? '0' : item) }))} />
                            ...
                            <div className="flex flex-col mb-[10px]">
                                <div className="flex flex-row items-center">
                                    ...
                                    <div className="flex flex-row items-center mr-[40px]">
                                        <input type="radio" id="fridayOne" name="fridayMorning" value="1" className="w-[20px] h-[20px] mr-[10px]" onClick={() => setSchedule((prevState) => ({ ...prevState, friday: prevState.friday.map((item, index) => index === 0 ? '1' : index === 1 ? '0' : item) }))} />
                                    ...
                                    <div className="flex flex-row items-center mr-[40px]">
                                        <input type="radio" id="fridayTwo" name="fridayMorning" value="1" className="w-[20px] h-[20px] mr-[10px]" onClick={() => setSchedule((prevState) => ({ ...prevState, friday: prevState.friday.map((item, index) => index === 1 ? '1' : index === 0 ? '0' : item) }))} />
                                ...
                                <div className="flex flex-row items-center">
                                    ...
                                    <div className="flex flex-row items-center mr-[40px]">
                                        <input type="radio" id="fridayThree" name="fridayAfternoon" value="1" className="w-[20px] h-[20px] mr-[10px]" onClick={() => setSchedule((prevState) => ({ ...prevState, friday: prevState.friday.map((item, index) => index === 2 ? '1' : index === 3 ? '0' : item) }))} />
                                    ...
                                    <div className="flex flex-row items-center mr-[40px]">
                                        <input type="radio" id="fridayFour" name="fridayAfternoon" value="1" className="w-[20px] h-[20px] mr-[10px]" onClick={() => setSchedule((prevState) => ({ ...prevState, friday: prevState.friday.map((item, index) => index === 3 ? '1' : index === 2 ? '0' : item) }))} />
                                ...
                                <div className="flex flex-row items-center">
                                    ...
                                    <div className="flex flex-row items-center mr-[40px]">
                                        <input type="radio" id="fridayFive" name="fridayEvening" value="1" className="w-[20px] h-[20px] mr-[10px]" onClick={() => setSchedule((prevState) => ({ ...prevState, friday: prevState.friday.map((item, index) => index === 4 ? '1' : index === 5 ? '0' : item) }))} />
                                    ...
                                    <div className="flex flex-row items-center mr-[40px]">
                                        <input type="radio" id="fridaySix" name="fridayEvening" value="1" className="w-[20px] h-[20px] mr-[10px]" onClick={() => setSchedule((prevState) => ({ ...prevState, friday: prevState.friday.map((item, index) => index === 5 ? '1' : index === 4 ? '0' : item) }))} />
                            ...
                            <div className="flex flex-col mb-[10px]">
                                <div className="flex flex-row items-center">
                                    ...
                                    <div className="flex flex-row items-center mr-[40px]">
                                        <input type="radio" id="saturdayOne" name="saturdayMorning" value="1" className="w-[20px] h-[20px] mr-[10px]" onClick={() => setSchedule((prevState) => ({ ...prevState, saturday: prevState.saturday.map((item, index) => index === 0 ? '1' : index === 1 ? '0' : item) }))} />
                                    ...
                                    <div className="flex flex-row items-center mr-[40px]">
                                        <input type="radio" id="saturdayTwo" name="saturdayMorning" value="1" className="w-[20px] h-[20px] mr-[10px]" onClick={() => setSchedule((prevState) => ({ ...prevState, saturday: prevState.saturday.map((item, index) => index === 1 ? '1' : index === 0 ? '0' : item) }))} />
                                ...
                                <div className="flex flex-row items-center">
                                    ...
                                    <div className="flex flex-row items-center mr-[40px]">
                                        <input type="radio" id="saturdayThree" name="saturdayAfternoon" value="1" className="w-[20px] h-[20px] mr-[10px]" onClick={() => setSchedule((prevState) => ({ ...prevState, saturday: prevState.saturday.map((item, index) => index === 2 ? '1' : index === 3 ? '0' : item) }))} />
                                    ...
                                    <div className="flex flex-row items-center mr-[40px]">
                                        <input type="radio" id="saturdayFour" name="saturdayAfternoon" value="1" className="w-[20px] h-[20px] mr-[10px]" onClick={() => setSchedule((prevState) => ({ ...prevState, saturday: prevState.saturday.map((item, index) => index === 3 ? '1' : index === 2 ? '0' : item) }))} />
                                ...
                                <div className="flex flex-row items-center">
                                    ...
                                    <div className="flex flex-row items-center mr-[40px]">
                                        <input type="radio" id="saturdayFive" name="saturdayEvening" value="1" className="w-[20px] h-[20px] mr-[10px]" onClick={() => setSchedule((prevState) => ({ ...prevState, saturday: prevState.saturday.map((item, index) => index === 4 ? '1' : index === 5 ? '0' : item) }))} />
                                    ...
                                    <div className="flex flex-row items-center mr-[40px]">
                                        <input type="radio" id="saturdaySix" name="saturdayEvening" value="1" className="w-[20px] h-[20px] mr-[10px]" onClick={() => setSchedule((prevState) => ({ ...prevState, saturday: prevState.saturday.map((item, index) => index === 5 ? '1' : index === 4 ? '0' : item) }))} />
                            ...
                            <div className="flex flex-col mb-[10px]">
                                <div className="flex flex-row items-center">
                                    ...
                                    <div className="flex flex-row items-center mr-[40px]">
                                        <input type="radio" id="sundayOne" name="sundayMorning" value="1" className="w-[20px] h-[20px] mr-[10px]" onClick={() => setSchedule((prevState) => ({ ...prevState, sunday: prevState.sunday.map((item, index) => index === 0 ? '1' : index === 1 ? '0' : item) }))} />
                                    ...
                                    <div className="flex flex-row items-center mr-[40px]">
                                        <input type="radio" id="sundayTwo" name="sundayMorning" value="1" className="w-[20px] h-[20px] mr-[10px]" onClick={() => setSchedule((prevState) => ({ ...prevState, sunday: prevState.sunday.map((item, index) => index === 1 ? '1' : index === 0 ? '0' : item) }))} />
                                ...
                                <div className="flex flex-row items-center">
                                    ...
                                    <div className="flex flex-row items-center mr-[40px]">
                                        <input type="radio" id="sundayThree" name="sundayAfternoon" value="1" className="w-[20px] h-[20px] mr-[10px]" onClick={() => setSchedule((prevState) => ({ ...prevState, sunday: prevState.sunday.map((item, index) => index === 2 ? '1' : index === 3 ? '0' : item) }))} />
                                    ...
                                    <div className="flex flex-row items-center mr-[40px]">
                                        <input type="radio" id="sundayFour" name="sundayAfternoon" value="1" className="w-[20px] h-[20px] mr-[10px]" onClick={() => setSchedule((prevState) => ({ ...prevState, sunday: prevState.sunday.map((item, index) => index === 3 ? '1' : index === 2 ? '0' : item) }))} />
                                ...
                                <div className="flex flex-row items-center">
                                    ...
                                    <div className="flex flex-row items-center mr-[40px]">
                                        <input type="radio" id="sundayFive" name="sundayEvening" value="1" className="w-[20px] h-[20px] mr-[10px]" onClick={() => setSchedule((prevState) => ({ ...prevState, sunday: prevState.sunday.map((item, index) => index === 4 ? '1' : index === 5 ? '0' : item) }))} />
                                    ...
                                    <div className="flex flex-row items-center mr-[40px]">
                                        <input type="radio" id="sundaySix" name="sundayEvening" value="1" className="w-[20px] h-[20px] mr-[10px]" onClick={() => setSchedule((prevState) => ({ ...prevState, sunday: prevState.sunday.map((item, index) => index === 5 ? '1' : index === 4 ? '0' : item) }))} />
