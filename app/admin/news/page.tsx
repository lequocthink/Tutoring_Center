    ...
    return (
        ...
        <div>
            <div className="shadow-[0_3px_10px_rgb(0,0,0,0.2)] p-4">
                <Link href="/admin/create/news" className="bg-green-500 hover:bg-green-700 text-white font-bold py-3 px-4 rounded">Thêm tin tức</Link>
            </div>
                            ...
                            <table className="min-w-full divide-y divide-gray-300">
                                <thead className="">
                                    <tr className="sticky z-10 bg-white top-0">
                                        <th scope="col" className="px-6 py-4 text-left font-medium text-black uppercase text-[20px]">Tên</th>
                                        <th scope="col" className="px-6 py-4 text-left font-medium text-black uppercase text-[20px]">Ngày tạo</th>
                                        <th scope="col" className="px-6 py-4 text-left font-medium text-black uppercase text-[20px]">Ngày cập nhật</th>
                                    ...
                                    {news.map((item) => (
                                        <tr key={item.id}>
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <Link href={'/admin/news/' + item.id} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded">
