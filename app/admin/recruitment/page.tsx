    ...
    return (
        ...
        <div>
            <div className="shadow-[0_3px_10px_rgb(0,0,0,0.2)] p-4">
                <Link href="/admin/create/recruitment" className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">Add new recruitment</Link>
            </div>
                            ...
                            <table className="min-w-full divide-y divide-gray-300">
                                <thead className="">
                                    <tr className="sticky z-10 bg-white top-0">
                                        ...
                                        <th scope="col" className="px-6 py-4 text-left text-xs font-medium text-black uppercase">Update At</th>
