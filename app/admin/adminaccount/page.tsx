    ...
    return (
        <div>
            <div className="shadow-[0_3px_10px_rgb(0,0,0,0.2)] p-4">
                <Link href="/admin/create/adminaccount" className="bg-green-500 hover:bg-green-700 text-white font-bold py-3 px-4 rounded">Tạo Admin</Link>
            </div>
                                            ...
                                            admin.map((item) => (
                                                <tr key={item.id}>
                                                    ...
                                                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                        <Link href={'/admin/adminaccount/' + item.id} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded">
                                                            Xem chi tiết
                                                        </Link>
                                                    </td>
                                                </tr>
